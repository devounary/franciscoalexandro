...
namespace franciscoalexandro.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DataLimite,Valor,EstaPago")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataLimite,Valor,EstaPago")] Pagamento pagamento)
        {
            if (id != pagamento.Id)
            {
                return NotFound();
