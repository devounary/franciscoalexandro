...
namespace franciscoalexandro.Controllers
{
    public class PagamentoComCartaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumeroDoCartao,Bandeira,Id,Nome,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumeroDoCartao,Bandeira,Id,Nome,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
