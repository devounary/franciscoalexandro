...
namespace franciscoalexandro.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Descricao,quantidade,preco,MarcaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Descricao,quantidade,preco,MarcaId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
