...
namespace franciscoalexandro.Controllers
{
    public class PagamentoComChequeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Banco,NomeDoBanco,Id,Nome,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Banco,NomeDoBanco,Id,Nome,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
